...
// #define COM_NUM_REQUEST 1 // Number of total request
...
// #define COM_CLIENT_THREAD_COUNT 1 // Number of threads in client, COM_NUM_REQUEST should be divisible by this Number
